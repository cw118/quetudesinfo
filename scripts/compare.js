    ...
    if (cegepOne === 'marianopolis') {
        ...
        program1.addEventListener('change', () => {
            ...
            if (programOne === 'Digital Arts & New Media') {
                ...
                programGrid1.src = 'stlambert/champ-stlam-lawcivilizationandmath.png';
        ...
        program1.addEventListener('change', () => {
            ...
            if (programOne === 'Arts, Literature and Communication') {
                programGrid1.src = 'stlawrence/champ-stlaw-alc.png';
                ...
                programGrid1.src = 'stlawrence/champ-stlaw-alcpriorspanish.png';
                ...
                programGrid1.src = 'stlawrence/champ-stlaw-scienceandalc.png';
                programGrid1.alt = 'Champlain St-Lawrence Science and ALC program grid';
            }
            else if (programOne === 'Health Science') {
                programGrid1.src = 'stlawrence/champ-stlaw-healthscience.png';
                programGrid1.alt = 'Champlain St-Lawrence Health Science program grid';
            }
            else if (programOne === 'Pure and Applied Science') {
                programGrid1.src = 'stlawrence/champ-stlaw-pureandappliedscience.png';
                programGrid1.alt = 'Champlain St-Lawrence Pure and Applied Science program grid';
            }
            else if (programOne === 'Science and Social Science') {
                programGrid1.src = 'stlawrence/champ-stlaw-scienceandsocialscience.png';
                ...
                programGrid1.src = 'stlawrence/champ-stlaw-discovery.png';
                ...
                programGrid1.src = 'stlawrence/champ-stlaw-psychology.png';
    ...
    if (cegepTwo === 'marianopolis') {
        ...
        program2.addEventListener('change', () => {
            ...
            if (programTwo === 'Digital Arts & New Media') {
                ...
                programGrid2.src = 'stlambert/champ-stlam-lawcivilizationandmath.png';
        ...
        program2.addEventListener('change', () => {
            ...
            if (programTwo === 'Arts, Literature and Communication') {
                programGrid2.src = 'stlawrence/champ-stlaw-alc.png';
                ...
                programGrid2.src = 'stlawrence/champ-stlaw-alcpriorspanish.png';
                ...
                programGrid2.src = 'stlawrence/champ-stlaw-scienceandalc.png';
                programGrid2.alt = 'Champlain St-Lawrence Science and ALC program grid';
            }
            else if (programTwo === 'Health Science') {
                programGrid2.src = 'stlawrence/champ-stlaw-healthscience.png';
                programGrid2.alt = 'Champlain St-Lawrence Health Science program grid';
            }
            else if (programTwo === 'Pure and Applied Science') {
                programGrid2.src = 'stlawrence/champ-stlaw-pureandappliedscience.png';
                programGrid2.alt = 'Champlain St-Lawrence Pure and Applied Science program grid';
            }
            else if (programTwo === 'Science and Social Science') {
                programGrid2.src = 'stlawrence/champ-stlaw-scienceandsocialscience.png';
                ...
                programGrid2.src = 'stlawrence/champ-stlaw-discovery.png';
                ...
                programGrid2.src = 'stlawrence/champ-stlaw-psychology.png';
